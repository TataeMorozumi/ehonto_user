...
urlpatterns = [
    ...
    path('more_read/', more_read, name='more_read'),

    # ✅ 設定・家族招待
    path('settings/', settings_view, name='settings_view'),
    path('family_invite/', family_invite, name='family_invite'),
    ...
    # ✅ 子どもの本棚ページ（修正）
    path('bookshelf/<int:child_id>/', child_bookshelf, name='child_bookshelf'),
    ...
    # ✅ 子ども情報編集・追加
    path('child/edit/', child_edit, name='child_edit'),
    path('child/add/', child_add, name='child_add'),
    path('child/<int:child_id>/edit/', child_update, name='child_update'),
    path('child/<int:child_id>/delete/', child_delete, name='child_delete'),
    ...
    # ✅ よんだ回数
    path('increment_read_count/', increment_read_count, name='increment_read_count'),
    ...
    # ✅ ふりかえり画面
    path("review/<int:year>/<int:month>/", review, name="review"),
    path("review/", review_default, name="review_default"),
